...
##  示例4
算法一$\left(\widehat{\mathbf{\Sigma} }_1\pmb{,}\widehat{\mathbf{\Sigma}}_2\right)=\underset{\mathbf{\Sigma} _1\in \mathbb{R}^{p\times p},\mathbf{\Sigma} _2\in \mathbb{R}^{q\times q}}{\text{argmin}} \left\| \widehat{\mathbf{\Sigma}}^N-\mathbf{\Sigma} _2\otimes \mathbf{\Sigma} _1\right\| _{\mathbf{F}}^2.$
记\(
...
\), 解为\[
\begin{aligned}
    \text{vec}(\mathbf{\Sigma}_1) &= \sqrt{\sigma_1} \mathbf{v}_1 \\
    \text{vec}(\mathbf{\Sigma}_2) &= \sqrt{\sigma_1} \mathbf{u}_1.
\end{aligned}
\]
